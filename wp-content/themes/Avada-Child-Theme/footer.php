...
?>
			...
			<?php if ( ! is_page_template( 'blank.php' ) ) : ?>
				...
				<div class="fusion-footer<?php echo esc_attr( $footer_parallax_class ); ?>">
					<div class="footer-form-widget"><?php dynamic_sidebar("footer-form-widget") ;?></div>
					<?php get_template_part( 'templates/footer-content' ); ?>
					<div class="certification-widget"><?php dynamic_sidebar("certification-widget") ;?></div>
					<div class="extracredit-widget"><?php dynamic_sidebar("extracredit-widget") ;?></div>
					<div class="idanfactor-widget"><?php dynamic_sidebar("idanfactor-widget") ;?></div>
				</div> <!-- fusion-footer -->
		...
		<div class="mobilecaller-wrap"><?php dynamic_sidebar("mobilecaller-widet") ;?>
		</div>
	</body>
</html>
